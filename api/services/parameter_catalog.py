...
PARAMETER_META: Dict[str, Dict[str, str]] = {
    ...
    "hydrology.dfs_flow_velocity_writer_variant": {
        "label_zh": "流速写出口径",
        "abbrev": "dfs_flow_velocity_writer_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_erosion_depth_writer_variant": {
        "label_zh": "侵蚀深度写出口径",
        "abbrev": "dfs_erosion_depth_writer_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_sfdf_classify_cv_variant": {
        "label_zh": "SF-DF-FF分箱浓度时相",
        "abbrev": "dfs_sfdf_classify_cv_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_cvlimit_variant": {
        "label_zh": "cvlimit钳制变种",
        "abbrev": "dfs_cvlimit_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_erodph_dt_variant": {
        "label_zh": "累计侵蚀erodph时步口径",
        "abbrev": "dfs_erodph_dt_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_barrier_flux_variant": {
        "label_zh": "挡墙/冲刷面通量清零口径",
        "abbrev": "dfs_barrier_flux_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_commit_cv_eps_variant": {
        "label_zh": "提交步cv<eps归零口径",
        "abbrev": "dfs_commit_cv_eps_variant",
        "group": "hydrology",
    },
    "hydrology.dfs_failure_source_policy": {
        "label_zh": "失稳源策略",
...
CONFIG_PATHS = {
    ...
    **{path: path for path in EDITABLE_PARAMETERS | READONLY_DISPLAY_PARAMETERS},
    ...
    "dfs_flow_velocity_writer_variant": "hydrology.dfs_flow_velocity_writer_variant",
    "dfs_erosion_depth_writer_variant": "hydrology.dfs_erosion_depth_writer_variant",
    "dfs_sfdf_classify_cv_variant": "hydrology.dfs_sfdf_classify_cv_variant",
    "dfs_cvlimit_variant": "hydrology.dfs_cvlimit_variant",
    "dfs_erodph_dt_variant": "hydrology.dfs_erodph_dt_variant",
    "dfs_barrier_flux_variant": "hydrology.dfs_barrier_flux_variant",
    "dfs_commit_cv_eps_variant": "hydrology.dfs_commit_cv_eps_variant",
...
LABELS = {
    ...
    "dfs_flow_velocity_writer_variant": "DFS flow-velocity writer variant",
    "hydrology.dfs_flow_velocity_writer_variant": "DFS flow-velocity writer variant",
    "dfs_erosion_depth_writer_variant": "DFS erosion-depth writer variant",
    "hydrology.dfs_erosion_depth_writer_variant": "DFS erosion-depth writer variant",
    "dfs_sfdf_classify_cv_variant": "DFS SF/DF/FF classify-cv variant",
    "hydrology.dfs_sfdf_classify_cv_variant": "DFS SF/DF/FF classify-cv variant",
    "dfs_cvlimit_variant": "DFS cvlimit clamp variant",
    "hydrology.dfs_cvlimit_variant": "DFS cvlimit clamp variant",
    "dfs_erodph_dt_variant": "DFS cumulative erodph timestep variant",
    "hydrology.dfs_erodph_dt_variant": "DFS cumulative erodph timestep variant",
    "dfs_barrier_flux_variant": "DFS barrier / scour face-flux kill variant",
    "hydrology.dfs_barrier_flux_variant": "DFS barrier / scour face-flux kill variant",
    "dfs_commit_cv_eps_variant": "DFS committed cv eps clamp variant",
    "hydrology.dfs_commit_cv_eps_variant": "DFS committed cv eps clamp variant",
